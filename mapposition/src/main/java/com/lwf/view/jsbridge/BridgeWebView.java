...
public class BridgeWebView extends WebView implements WebViewJavascriptBridge {
    ...
    private void doSend(String handlerName, String data, CallBackFunction responseCallback) {
        ...
        if (responseCallback != null) {
            String callbackStr = String
                .format(BridgeUtil.CALLBACK_ID_FORMAT, ++uniqueId + (BridgeUtil.UNDERLINE_STR + SystemClock.currentThreadTimeMillis()));
                ...
                public void onCallBack(String data) {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        if (!TextUtils.isEmpty(responseId)) {
                            ...
                            Log.d("lk_test", "BridgeWebView.flushMessageQueue:: try to call [" + m.getHandlerName() + "] function...");
                            ...
                            if (null != handler) {
                                ...
                                Log.d("lk_test", "BridgeWebView.flushMessageQueue:: " + m.getHandlerName() + ":: handler is null...");
                            }
                        }
                    }
                }
